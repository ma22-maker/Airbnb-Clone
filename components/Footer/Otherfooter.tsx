...
function Otherfooter() {
  return (
   <>
   <div className="flex flex-col items-start justify-between  mx-0 sm:mx-0 md:mx-7  py-5 px-7 text-sm bg-zinc-50 text-zinc-900 border-t border-gray-200 lg:py-6 lg:flex-row">
